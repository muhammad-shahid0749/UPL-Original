...
class CKPlus(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_ck_plus.json")
...
@DATASET_REGISTRY.register()
class OpensetCKPlus(UPLDatasetBase):
